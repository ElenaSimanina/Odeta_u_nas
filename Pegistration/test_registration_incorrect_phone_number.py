print('Регистрация с некорректным номером телефона')
...
#with sync_playwright() as p:
    ...
    page.fill('//input [@id="usernamereg"]', 'Anacrhhhh')
    ...
    if page.locator('//span [@id="viv_telefonreg"]'):
        print('Ошибка! Используются неразрешенные символы')
    else:
        print('NOT OK')
